            ...
            <div className='box-top'>
                ...
                <div class="dropdown">
                    <select class="filter-drp" onChange={handleOnChange}>
                        <option className="dropdown-item" value={status} disabled selected>Filter</option>
                        <option className="dropdown-item" value="All">All</option>
                        <option className="dropdown-item" value="0">Pending</option>
                        <option className="dropdown-item" value="2">Canceled</option>
                        <option className="dropdown-item" value="1">Confirmed</option>
                    </select>
                </div>
            </div>
