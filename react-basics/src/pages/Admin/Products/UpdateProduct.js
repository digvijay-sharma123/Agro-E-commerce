                    ...
                    <div className='ap-box'>
                        <div className='ap-left'>
                            <div className="general-box">
                                ...
                                <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="name-input" placeholder='Enter Product Name' required></input>
                                <label>Product Description</label>
                                <textarea type="text" value={description} onChange={(e) => setDescription(e.target.value)} className="desc-input" placeholder='Description'></textarea>
                            </div>
